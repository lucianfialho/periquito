...
enum KeychainManager {
    ...
    private static let loroService = "com.ruban.loro"
    ...
    static func getAnthropicApiKey() -> String? {
        readString(service: loroService, account: anthropicApiKeyAccount)
    }

    static func setAnthropicApiKey(_ key: String?) {
        if let key, !key.isEmpty {
            saveString(key, service: loroService, account: anthropicApiKeyAccount)
        } else {
            deleteItem(service: loroService, account: anthropicApiKeyAccount)
        }
    }
    ...
    static func getCachedOAuthToken() -> String? {
        readString(service: loroService, account: cachedOAuthTokenAccount)
    }

    static func cacheOAuthToken(_ token: String) {
        saveString(token, service: loroService, account: cachedOAuthTokenAccount)
    }

    static func clearCachedOAuthToken() {
        deleteItem(service: loroService, account: cachedOAuthTokenAccount)
    }
