...
extension Notification.Name {
    static let loroShouldCollapse = Notification.Name("loroShouldCollapse")
}
...
struct NotchContentView: View {
    var stateMachine: LoroStateMachine = .shared
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .loroShouldCollapse)) { _ in
