#!/bin/bash
# Loro Hook - forwards Claude Code events to Loro app via Unix socket
...
export LORO_INTERACTIVE=$IS_INTERACTIVE
...
output = {
    ...
    'pid': None,
    'tty': None,
    'interactive': os.environ.get('LORO_INTERACTIVE', 'true') == 'true',
