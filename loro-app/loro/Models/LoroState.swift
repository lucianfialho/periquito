...
enum LoroTask: String, CaseIterable {
...
enum LoroEmotion: String, CaseIterable {
...
struct LoroState: Equatable {
    var task: LoroTask
    var emotion: LoroEmotion = .neutral
    ...
    static let idle = LoroState(task: .idle)
    static let working = LoroState(task: .working)
    static let sleeping = LoroState(task: .sleeping)
    static let compacting = LoroState(task: .compacting)
    static let waiting = LoroState(task: .waiting)
}
