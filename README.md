...
1. Download `Periquito-x.x.x.dmg` from the [latest GitHub Release](https://github.com/sk-ruban/periquito/releases/latest)
2. Open the DMG and drag Periquito to Applications
3. Launch Periquito — it auto-installs Claude Code hooks on first launch
...
6. Start using Claude Code and watch Periquito react
...
If you have any bugs, ideas, or would like to contribute through pull requests, please check out [Contributing to Periquito](CONTRIBUTING.md).

## Credits

- [Claude Island](https://github.com/farouqaldori/claude-island) — design inspiration for the app
- [Readout](https://readout.org) — design inspiration for [periquito.app](https://periquito.app)
