...
private let logger = Logger(subsystem: "com.ruban.loro", category: "StateMachine")

@MainActor
@Observable
final class LoroStateMachine {
    static let shared = LoroStateMachine()
