...
private let logger = Logger(subsystem: "com.ruban.loro", category: "HookInstaller")
...
struct HookInstaller {
    ...
    static func installIfNeeded() -> Bool {
        ...
        let hookScript = hooksDir.appendingPathComponent("loro-hook.sh")
        ...
        if let bundled = Bundle.main.url(forResource: "loro-hook", withExtension: "sh") {
            do {
    ...
    private static func updateSettings(at settingsURL: URL) -> Bool {
        ...
        let command = "~/.claude/hooks/loro-hook.sh"
                ...
                let hasOurHook = existingEvent.contains { entry in
                    if let entryHooks = entry["hooks"] as? [[String: Any]] {
                        return entryHooks.contains { h in
                            ...
                            return cmd.contains("loro-hook.sh")
                        }
                    }
                    return false
                }
        ...
        do {
            ...
            logger.info("Updated settings.json with Loro hooks")
            return true
        } catch {
        ...
        return hooks.values.contains { value in
            ...
            return entries.contains { entry in
                ...
                return entryHooks.contains { hook in
                    (hook["command"] as? String)?.contains("loro-hook.sh") == true
                }
            }
        }
    }
    ...
    static func uninstall() {
        ...
        logger.info("Uninstalled Loro hooks")
    }
}
